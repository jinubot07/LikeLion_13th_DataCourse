...
*  머신러닝 알고리즘
   ...
   * 의사 결정 트리, 랜덤포레스트 시각화 [code](https://jinubot07.github.io/LikeLion_13th_DataCourse/09_data_analysis/html%20code/ch06_ensemble_Randomforest(4).html)
   * 앙상블 그래디언트 부스팅 결정트리 [code](https://jinubot07.github.io/LikeLion_13th_DataCourse/09_data_analysis/html%20code/ch06_ensemble_gradient_boosting.html)

### 데이터 전처리
* 데이터 전처리
   * 분석 [code](https://jinubot07.github.io/LikeLion_13th_DataCourse/09_data_analysis/html%20code/데이터전처리.html)
* 원핫인코딩
