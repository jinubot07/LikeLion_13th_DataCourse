...
# 1-0.             터미널에서 입력받기 : 잡코리아 ID와 비번, 검색하려는 기업명
# 1-1.       잡코리아 메인 사이트 접속 : https://www.jobkorea.co.kr/
# 1-2.                   로 그인 과정 : 탭 클릭 -> ID 및 비밀번호 입력 -> 버튼 클릭
...
# 5-1.              텍스트 데이터 저장 : "기업명_합격자소서.csv" csv 저장
# 5-2.                  데이터 전처리 : 의미 없는 어미와 조사 제거
# 5-3.                        시각화  : wordcloud로 "기업명_합격자소서_wordcloud.png" png 저장
####################################################################################
